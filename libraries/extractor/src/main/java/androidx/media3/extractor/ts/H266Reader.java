...
public final class H266Reader implements ElementaryStreamReader {
  ...
  @Nullable public static Format parseMediaFormat(
    ...
    String codecs = CodecSpecificDataUtil.buildVvcCodecString(atomType, spsData.profileIdc, spsData.tierFlag, spsData.levelIdc);
  ...
  @Nullable public static Format parseMediaFormat(
      ...
      NalUnitTargetBuffer sps,
      NalUnitTargetBuffer pps) {
    return parseMediaFormat(0x76766331, // vvc1
        formatId, vps, sps, pps);
  }
